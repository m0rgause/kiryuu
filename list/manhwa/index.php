        ...
        <div class="konten">
            ...
            <section id="Terbaru" style="margin-bottom: 100px;">
                ...
                <div style="margin-left:100px; margin-right:100px;">
                    <a style="float: right;" href="<?= base_url() . "/list/manhwa?page=" . $page + 1 ?>"> Next Page</a>
                    <?php if ($page > 1) : ?>
                        <a style="float: left;" href="<?= base_url() . "/list/manhwa?page=" . $page - 1 ?>"> Prev Page</a>
                    <?php endif ?>
