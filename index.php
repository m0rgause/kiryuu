...
<body class="home" id="body">
    ...
    <main class="main" style="margin-top: 20px;">
        <div class="konten">
                        ...
                        <div class="ls12">
                            <?php foreach ($data['populars'] as $popular) : ?>
                                <div class="ls2">
                                    ...
                                    <div class="ls2j">
                                        <h4>
                                            <a href="<?= base_url() . $popular['link'] ?>"><?= $popular['title'] ?></a>
                                        </h4>
                                        <span class="ls2t">Rating : <?= $popular['rating'] ?></span>
                                        <a href="<?= base_url() . $popular['link'] ?>" class="ls2l"><?= $popular['last_chapter'] ?></a>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </div>
            ...
            <section id="Terbaru"> <a href="<?= base_url() . "/project" ?>" class="lnn" style="margin-bottom:15px">Projek Update (klik)</a>
                <div class="ls4w">
                    <?php foreach ($data['projects'] as $project) : ?>
                        <div class="ls4">
                            <div class="ls4v"> <a href="<?= base_url() . $project['link'] ?>"> <img class="lazy" src="" data-src="https://cdn.statically.io/img/<?= str_replace('https://', '', $project['image']) ?>?resize=240,171"> </a>
                                ...
                                <span class="up">Up <?= count($project['last_update']) ?></span>
                            </div>
                            <div class="ls4j">
                                <h4> <a href="<?= base_url() . $project['link'] ?>"><?= $project['title'] ?></a> </h4> <span class="ls4s"><?= $project['type'] ?> • <?= $project['last_update'][0]['updated_at'] ?></span><br> <a href="<?= base_url() . "/ch" . $project['last_update'][0]['link'] ?>" class="ls24"><?= $project['last_update'][0]['chapter'] ?></a>
                            </div>
                        </div>
                    <?php endforeach ?>
            ...
            <section id="Terbaru" style="margin-bottom: 100px;">
                <a href="<?= base_url() . "/new-release" ?>" class="lnn" style="margin-bottom:50px;">New Release (klik)</a>
                <div class="ls4w">
                    <?php foreach ($data['new_release'] as $newR) : ?>
                        <div class="ls4">
                            <div class="ls4v"> <a href="<?= base_url() . $newR['link'] ?>">
                                ...
                                <span class="up">Up <?= count($newR['last_update']) ?></span>
                            </div>
                            <div class="ls4j">
                                <h4> <a href="<?= base_url() . $newR['link'] ?>"><?= $newR['title'] ?></a> </h4> <span class="ls4s"><?= $newR['type'] ?> • <?= $newR['last_update'][0]['updated_at'] ?></span><br> <a href="<?= base_url() . "/ch" . $newR['last_update'][0]['link'] ?>" class="ls24"><?= $newR['last_update'][0]['chapter'] ?></a>
                            </div>
                        </div>
                    <?php endforeach ?>
            ...
            <section id="Berita">
                ...
                <script>
                    ...
                    if (localStorage.getItem("history") != null) {
                        document.getElementById("history2").classList.add("add");
                    } else {
                        document.getElementById('history').innerHTML += '<p>History kamu masih kosong.</p>';
                    }
                </script>
            </section>
        ...
        <div class="weww" style="width:100%;float:left;margin-bottom:180px;text-align:center"> <img class="lazy" data-src="https://komiku.id/asset/img/Loading.gif"> </div>
        <div class="pagination" style="display:none"> <a href="/index2.html" class="next">Next</a> </div>
        <div class="loading" style="display:none"> </div>
        <div id="Melayang" style="display:none"><a onclick="document.getElementById('Melayang').style.display='none';">x close</a>
            <div class="cover-iklan i300x250"></div>
        </div>
